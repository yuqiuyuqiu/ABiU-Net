...
class PyramidVisionTransformer(nn.Module):
    def __init__(self, img_size=384, patch_size=4, in_chans=3, embed_dims=[64, 128, 256, 512],
...
class pvt_small(PyramidVisionTransformer):
    def __init__(self, **kwargs):
        super(pvt_small, self).__init__(
            img_size=384, patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8],
